  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-primary/70">Store overview and recent activity.</p>
      </div>
      
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-sm font-medium font-sans text-primary/70">Total Revenue</CardTitle>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-sm font-medium font-sans text-primary/70">Orders</CardTitle>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-sm font-medium font-sans text-primary/70">Products</CardTitle>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-sm font-medium font-sans text-primary/70">Customers</CardTitle>
      ...
      <div>
        <h2 className="text-xl font-serif font-bold text-primary mb-4">Recent Orders</h2>
          ...
          <table className="w-full text-sm text-left">
            ...
            <tbody>
              {recentOrders.map(order => {
                ...
                return (
                  <tr key={order.id} className="border-t border-border/10">
